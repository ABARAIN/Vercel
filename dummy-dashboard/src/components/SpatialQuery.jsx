...
const SpatialQuery = ({ map, geojsonData, setGeojsonData, landuseFilter, setFullGeojsonBackup,setClickedPlotDetails }) => {
  ...
  useEffect(() => {
    axios.get('https://api.nespaklrms.com/api/all-soc-dropdowns/?level=district')
  ...
  useEffect(() => {
    ...
    if (selectedDistrict) {
      axios.get(`https://api.nespaklrms.com/api/all-soc-dropdowns/?level=tehsil&district=${selectedDistrict}`)
  ...
  useEffect(() => {
    ...
    if (selectedDistrict && selectedTehsil) {
      axios.get(`https://api.nespaklrms.com/api/all-soc-dropdowns/?level=town_name&district=${selectedDistrict}&tehsil=${selectedTehsil}`)
  ...
  useEffect(() => {
    ...
    if (selectedDistrict && selectedTehsil && selectedTown) {
      axios.get(`https://api.nespaklrms.com/api/all-soc-dropdowns/?level=block&district=${selectedDistrict}&tehsil=${selectedTehsil}&town_name=${selectedTown}`)
  ...
  useEffect(() => {
    ...
    if (selectedDistrict && selectedTehsil && selectedTown && selectedBlock) {
      axios.get(`https://api.nespaklrms.com/api/all-soc-dropdowns/?level=plot_no&district=${selectedDistrict}&tehsil=${selectedTehsil}&town_name=${selectedTown}&block=${selectedBlock}`)
        .then(res => {
